...
class self_consumer:
    ...
    def benefit_autoconsumed_energy(
        self,
        energy_consumed: int | float,
        implant_power: int | float,
        implant_year: datetime.date,
        boosting_power: int,
        region: str,
    ) -> int | float:
        benefit_autoconsumed = computations.incentive_self_consumption(
            energy_consumed, implant_power, implant_year, boosting_power, region
        )
...
class groups_self_consumers(self_consumer):
    ...
    def total_benefit(
        ...
        benefit_autoconsumed = self.benefit_autoconsumed_energy(
