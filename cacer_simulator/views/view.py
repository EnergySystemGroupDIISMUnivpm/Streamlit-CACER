...
from cacer_simulator.models import parameters  ## cosi sono dipendenti model e view???
import datetime
from typing import Dict, Never, Tuple
class UserInput:
    ...
    def insert_annual_consumption(self, label):
    ...
    def insert_year_power_PV(self) -> Tuple[datetime.date | Tuple[Never] | Tuple[datetime.date] | Tuple[datetime.date] | None | int]: ### tipizzazione tupla???
